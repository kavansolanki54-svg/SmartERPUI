...
const COLUMNS = [
  ...
  { key: 'fromAccount', label: 'FROM ACCOUNT', align: 'left', sortable: true, filterable: true, filterType: 'text', width: '180px' },
  { key: 'toAccount', label: 'TO ACCOUNT', align: 'left', sortable: true, filterable: true, filterType: 'text', width: '180px' },
...
const ContraVoucherList = () => {
  ...
  const fetchVouchers = async () => {
    ...
    try {
      ...
      console.error(error);
      toast.error('Error loading contra vouchers');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = (id) => {
    toast((t) => (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <span style={{ fontSize: '14px', fontWeight: '500' }}>Delete this contra voucher?</span>
        <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
          ...
          <button onClick={async () => {
            ...
            try {
              ...
              toast.error('Error deleting contra voucher');
            }
  ...
  const enrichedData = useMemo(() => {
    return vouchers.map(v => ({
      ...
      fromAccount: v.fromLedgerName || '-',
      toAccount: v.toLedgerName || '-',
  ...
  return (
    <div className="list-page-container">
      <EnterpriseDataGrid
        ...
        data={enrichedData}
        loading={loading}
        createLink="/Contra/create"
        createLabel="Add Contra Voucher"
        editLinkPrefix="/Contra/edit"
        onDelete={handleDelete}
        idKey="contraVoucherHeaderId"
