...
const COLUMNS = [
  ...
  { key: 'accountName', label: 'ACCOUNT (CREDIT)', align: 'left', sortable: true, filterable: true, filterType: 'text', width: '220px' },
  ...
  const handleDelete = (id) => {
    toast((t) => (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <span style={{ fontSize: '14px', fontWeight: '500' }}>Delete this payment voucher?</span>
  ...
  return (
    <div className="list-page-container">
      <EnterpriseDataGrid
        ...
        createLabel="Add Payment Voucher"
        editLinkPrefix="/Payment/edit"
        onDelete={handleDelete}
        idKey="paymentVoucherHeaderId"
